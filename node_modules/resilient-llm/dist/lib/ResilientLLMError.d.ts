 ...
 */
export type ResilientLLMErrorCode = "JSON_PARSE_ERROR" | "JSON_MODE_FAILURE" | "SCHEMA_MISMATCH" | "VALIDATION_ERROR" | "PROVIDER_BAD_REQUEST" | "PROVIDER_UNAUTHORIZED" | "PROVIDER_FORBIDDEN" | "PROVIDER_NOT_FOUND" | "PROVIDER_RATE_LIMIT" | "PROVIDER_INTERNAL_ERROR" | "PROVIDER_UNAVAILABLE" | "PROVIDER_OVERLOADED" | "PROVIDER_ERROR" | "TIMEOUT" | "CIRCUIT_OPEN" | "RATE_LIMIT_EXHAUSTED" | "ABORTED" | "BULKHEAD_EXHAUSTED" | "INVALID_PROVIDER" | "MISSING_CREDENTIALS" | "INVALID_MODEL" | "INVALID_REQUEST" | "UNSUPPORTED_FEATURE" | "UNKNOWN";
/**
 ...
 */
export declare class ResilientLLMError extends Error {
    readonly code: ResilientLLMErrorCode;
    readonly retryable: boolean;
    readonly metadata: OperationMetadata | undefined;
    constructor(message: string, code: ResilientLLMErrorCode, options?: {
        cause?: unknown;
        metadata?: OperationMetadata;
        retryable?: boolean;
    });
}
//# sourceMappingURL=ResilientLLMError.d.ts.map